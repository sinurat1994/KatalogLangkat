...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
	...
	background-image: url(KANTOR.png);
}
</style>
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di Katalog Warkah/SU/Buku Tanah, Untuk Login Admin silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
          </div>
            </div>

                                              
                <div class="footer-main">
                    Copyright &copy BPN Langkat 2023
                </div>
            </aside><!-- /.right-side -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Katalog</h4>
      </div>
